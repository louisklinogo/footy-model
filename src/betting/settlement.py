...
def settle_market(
    ...
    *,
    ...
    goals_markets: dict[str, GoalsRule] = {
        ...
        "ho15": lambda h, a: h >= 2,
        "ao15": lambda h, a: a >= 2,
        "home_or_o25": lambda h, a: (h > a) or (h + a >= 3),
        "away_or_o25": lambda h, a: (a > h) or (h + a >= 3),
        "home_or_o15": lambda h, a: (h > a) or (h + a >= 2),
        "away_or_o15": lambda h, a: (a > h) or (h + a >= 2),
        "home_and_o25": lambda h, a: (h > a) and (h + a >= 3),
        "away_and_o25": lambda h, a: (a > h) and (h + a >= 3),
